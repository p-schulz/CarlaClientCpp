...
class TestConflictingSymbolNames : public ::google::protobuf::Message {
 ...
 public:
  ...
  inline bool has_typedecl() const;
  inline void clear_typedecl();
  static const int kTypedeclFieldNumber = 39;
  inline ::google::protobuf::uint32 typedecl() const;
  inline void set_typedecl(::google::protobuf::uint32 value);
