...
void TestOptimizedForSize::InitAsDefaultInstance() {
  ...
  const_cast< ::google::protobuf::internal::ArenaStringPtr*>(&TestOptimizedForSize_default_oneof_instance_->string_field_)->UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
