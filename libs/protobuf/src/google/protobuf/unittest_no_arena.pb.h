...
class TestAllTypes : public ::google::protobuf::Message {
 public:
  ...
  inline const ::protobuf_unittest_no_arena::TestAllTypes_OptionalGroup& optionalgroup() const;
  inline ::protobuf_unittest_no_arena::TestAllTypes_OptionalGroup* mutable_optionalgroup();
  inline ::protobuf_unittest_no_arena::TestAllTypes_OptionalGroup* release_optionalgroup();
  inline void set_allocated_optionalgroup(::protobuf_unittest_no_arena::TestAllTypes_OptionalGroup* optionalgroup);
  ...
  inline const ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage& optional_nested_message() const;
  inline ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage* mutable_optional_nested_message();
  inline ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage* release_optional_nested_message();
  inline void set_allocated_optional_nested_message(::protobuf_unittest_no_arena::TestAllTypes_NestedMessage* optional_nested_message);
  ...
  inline const ::protobuf_unittest_no_arena::ForeignMessage& optional_foreign_message() const;
  inline ::protobuf_unittest_no_arena::ForeignMessage* mutable_optional_foreign_message();
  inline ::protobuf_unittest_no_arena::ForeignMessage* release_optional_foreign_message();
  inline void set_allocated_optional_foreign_message(::protobuf_unittest_no_arena::ForeignMessage* optional_foreign_message);
  ...
  inline ::protobuf_unittest_no_arena::TestAllTypes_NestedEnum optional_nested_enum() const;
  inline void set_optional_nested_enum(::protobuf_unittest_no_arena::TestAllTypes_NestedEnum value);
  ...
  inline ::protobuf_unittest_no_arena::ForeignEnum optional_foreign_enum() const;
  inline void set_optional_foreign_enum(::protobuf_unittest_no_arena::ForeignEnum value);
 ...
 public:
  ...
  inline const ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage& optional_lazy_message() const;
  inline ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage* mutable_optional_lazy_message();
  inline ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage* release_optional_lazy_message();
  inline void set_allocated_optional_lazy_message(::protobuf_unittest_no_arena::TestAllTypes_NestedMessage* optional_lazy_message);
  ...
  inline const ::protobuf_unittest_no_arena::TestAllTypes_RepeatedGroup& repeatedgroup(int index) const;
  inline ::protobuf_unittest_no_arena::TestAllTypes_RepeatedGroup* mutable_repeatedgroup(int index);
  inline ::protobuf_unittest_no_arena::TestAllTypes_RepeatedGroup* add_repeatedgroup();
  ...
  inline const ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage& repeated_nested_message(int index) const;
  inline ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage* mutable_repeated_nested_message(int index);
  inline ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage* add_repeated_nested_message();
  ...
  inline const ::protobuf_unittest_no_arena::ForeignMessage& repeated_foreign_message(int index) const;
  inline ::protobuf_unittest_no_arena::ForeignMessage* mutable_repeated_foreign_message(int index);
  inline ::protobuf_unittest_no_arena::ForeignMessage* add_repeated_foreign_message();
  ...
  inline ::protobuf_unittest_no_arena::TestAllTypes_NestedEnum repeated_nested_enum(int index) const;
  inline void set_repeated_nested_enum(int index, ::protobuf_unittest_no_arena::TestAllTypes_NestedEnum value);
  inline void add_repeated_nested_enum(::protobuf_unittest_no_arena::TestAllTypes_NestedEnum value);
  ...
  inline ::protobuf_unittest_no_arena::ForeignEnum repeated_foreign_enum(int index) const;
  inline void set_repeated_foreign_enum(int index, ::protobuf_unittest_no_arena::ForeignEnum value);
  inline void add_repeated_foreign_enum(::protobuf_unittest_no_arena::ForeignEnum value);
 ...
 public:
  ...
  inline const ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage& repeated_lazy_message(int index) const;
  inline ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage* mutable_repeated_lazy_message(int index);
  inline ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage* add_repeated_lazy_message();
  inline const ::google::protobuf::RepeatedPtrField< ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage >&
  ...
  inline ::protobuf_unittest_no_arena::TestAllTypes_NestedEnum default_nested_enum() const;
  inline void set_default_nested_enum(::protobuf_unittest_no_arena::TestAllTypes_NestedEnum value);
  ...
  inline ::protobuf_unittest_no_arena::ForeignEnum default_foreign_enum() const;
  inline void set_default_foreign_enum(::protobuf_unittest_no_arena::ForeignEnum value);
 ...
 public:
  ...
  inline const ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage& oneof_nested_message() const;
  inline ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage* mutable_oneof_nested_message();
  inline ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage* release_oneof_nested_message();
  inline void set_allocated_oneof_nested_message(::protobuf_unittest_no_arena::TestAllTypes_NestedMessage* oneof_nested_message);
 ...
 private:
  ...
  ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage* optional_lazy_message_;
...
class TestNoArenaMessage : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_arena_message() const;
  inline void clear_arena_message();
  static const int kArenaMessageFieldNumber = 1;
  inline const ::proto2_arena_unittest::ArenaMessage& arena_message() const;
  inline ::proto2_arena_unittest::ArenaMessage* mutable_arena_message();
  inline ::proto2_arena_unittest::ArenaMessage* release_arena_message();
  inline void set_allocated_arena_message(::proto2_arena_unittest::ArenaMessage* arena_message);
...
inline const ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage& TestAllTypes::optional_lazy_message() const {
  // @@protoc_insertion_point(field_get:protobuf_unittest_no_arena.TestAllTypes.optional_lazy_message)
  return optional_lazy_message_ != NULL ? *optional_lazy_message_ : *default_instance_->optional_lazy_message_;
}
inline ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage* TestAllTypes::mutable_optional_lazy_message() {
  set_has_optional_lazy_message();
  if (optional_lazy_message_ == NULL) {
    optional_lazy_message_ = new ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage;
  }
  // @@protoc_insertion_point(field_mutable:protobuf_unittest_no_arena.TestAllTypes.optional_lazy_message)
  return optional_lazy_message_;
}
inline ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage* TestAllTypes::release_optional_lazy_message() {
  clear_has_optional_lazy_message();
  ::protobuf_unittest_no_arena::TestAllTypes_NestedMessage* temp = optional_lazy_message_;
  optional_lazy_message_ = NULL;
  return temp;
}
inline void TestAllTypes::set_allocated_optional_lazy_message(::protobuf_unittest_no_arena::TestAllTypes_NestedMessage* optional_lazy_message) {
  ...
  // @@protoc_insertion_point(field_set_allocated:protobuf_unittest_no_arena.TestAllTypes.optional_lazy_message)
}
