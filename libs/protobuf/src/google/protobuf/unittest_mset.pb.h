...
class TestMessageSetContainer : public ::google::protobuf::Message {
 public:
  ...
  inline ::protobuf_unittest::TestMessageSet* unsafe_arena_release_message_set();
  inline void unsafe_arena_set_allocated_message_set(
...
class TestMessageSetExtension2 : public ::google::protobuf::Message {
 public:
  ...
  inline ::std::string* unsafe_arena_release_str();
  inline void unsafe_arena_set_allocated_str(
      ::std::string* str);
...
class RawMessageSet_Item : public ::google::protobuf::Message {
 public:
  ...
  inline ::std::string* unsafe_arena_release_message();
  inline void unsafe_arena_set_allocated_message(
      ::std::string* message);
...
inline ::protobuf_unittest::TestMessageSet* TestMessageSetContainer::unsafe_arena_release_message_set() {
  clear_has_message_set();
  ::protobuf_unittest::TestMessageSet* temp = message_set_;
  message_set_ = NULL;
  return temp;
...
inline void TestMessageSetContainer::set_allocated_message_set(::protobuf_unittest::TestMessageSet* message_set) {
  ...
  if (message_set != NULL) {
    if (GetArenaNoVirtual() != NULL && 
      ...
      GetArenaNoVirtual()->Own(message_set);
