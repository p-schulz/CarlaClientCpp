...
class TestAllTypes : public ::google::protobuf::Message {
 public:
  ...
  inline const ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage& optional_nested_message() const;
  inline ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* mutable_optional_nested_message();
  inline ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* release_optional_nested_message();
  inline void set_allocated_optional_nested_message(::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* optional_nested_message);
  ...
  inline const ::proto2_nofieldpresence_unittest::ForeignMessage& optional_foreign_message() const;
  inline ::proto2_nofieldpresence_unittest::ForeignMessage* mutable_optional_foreign_message();
  inline ::proto2_nofieldpresence_unittest::ForeignMessage* release_optional_foreign_message();
  inline void set_allocated_optional_foreign_message(::proto2_nofieldpresence_unittest::ForeignMessage* optional_foreign_message);

  // optional .protobuf_unittest.TestAllTypes optional_proto2_message = 20;
  inline bool has_optional_proto2_message() const;
  inline void clear_optional_proto2_message();
  static const int kOptionalProto2MessageFieldNumber = 20;
  inline const ::protobuf_unittest::TestAllTypes& optional_proto2_message() const;
  inline ::protobuf_unittest::TestAllTypes* mutable_optional_proto2_message();
  inline ::protobuf_unittest::TestAllTypes* release_optional_proto2_message();
  inline void set_allocated_optional_proto2_message(::protobuf_unittest::TestAllTypes* optional_proto2_message);
  ...
  inline ::proto2_nofieldpresence_unittest::TestAllTypes_NestedEnum optional_nested_enum() const;
  inline void set_optional_nested_enum(::proto2_nofieldpresence_unittest::TestAllTypes_NestedEnum value);
  ...
  inline ::proto2_nofieldpresence_unittest::ForeignEnum optional_foreign_enum() const;
  inline void set_optional_foreign_enum(::proto2_nofieldpresence_unittest::ForeignEnum value);
 ...
 public:
  ...
  inline const ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage& optional_lazy_message() const;
  inline ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* mutable_optional_lazy_message();
  inline ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* release_optional_lazy_message();
  inline void set_allocated_optional_lazy_message(::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* optional_lazy_message);
  ...
  inline const ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage& repeated_nested_message(int index) const;
  inline ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* mutable_repeated_nested_message(int index);
  inline ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* add_repeated_nested_message();
  ...
  inline const ::proto2_nofieldpresence_unittest::ForeignMessage& repeated_foreign_message(int index) const;
  inline ::proto2_nofieldpresence_unittest::ForeignMessage* mutable_repeated_foreign_message(int index);
  inline ::proto2_nofieldpresence_unittest::ForeignMessage* add_repeated_foreign_message();
  ...
  inline int repeated_proto2_message_size() const;
  inline void clear_repeated_proto2_message();
  static const int kRepeatedProto2MessageFieldNumber = 50;
  inline const ::protobuf_unittest::TestAllTypes& repeated_proto2_message(int index) const;
  inline ::protobuf_unittest::TestAllTypes* mutable_repeated_proto2_message(int index);
  inline ::protobuf_unittest::TestAllTypes* add_repeated_proto2_message();
  ...
  inline ::proto2_nofieldpresence_unittest::TestAllTypes_NestedEnum repeated_nested_enum(int index) const;
  inline void set_repeated_nested_enum(int index, ::proto2_nofieldpresence_unittest::TestAllTypes_NestedEnum value);
  inline void add_repeated_nested_enum(::proto2_nofieldpresence_unittest::TestAllTypes_NestedEnum value);
  ...
  inline ::proto2_nofieldpresence_unittest::ForeignEnum repeated_foreign_enum(int index) const;
  inline void set_repeated_foreign_enum(int index, ::proto2_nofieldpresence_unittest::ForeignEnum value);
  inline void add_repeated_foreign_enum(::proto2_nofieldpresence_unittest::ForeignEnum value);
 ...
 public:
  ...
  inline const ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage& repeated_lazy_message(int index) const;
  inline ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* mutable_repeated_lazy_message(int index);
  inline ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* add_repeated_lazy_message();
  inline const ::google::protobuf::RepeatedPtrField< ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage >&
  ...
  inline const ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage& oneof_nested_message() const;
  inline ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* mutable_oneof_nested_message();
  inline ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* release_oneof_nested_message();
  inline void set_allocated_oneof_nested_message(::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* oneof_nested_message);
  ...
  private:
  inline bool has_oneof_enum() const;
  public:
  inline void clear_oneof_enum();
  static const int kOneofEnumFieldNumber = 114;
  inline ::proto2_nofieldpresence_unittest::TestAllTypes_NestedEnum oneof_enum() const;
  inline void set_oneof_enum(::proto2_nofieldpresence_unittest::TestAllTypes_NestedEnum value);
...
class TestProto2Required : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_proto2() const;
  inline void clear_proto2();
  static const int kProto2FieldNumber = 1;
  inline const ::protobuf_unittest::TestRequired& proto2() const;
  inline ::protobuf_unittest::TestRequired* mutable_proto2();
  inline ::protobuf_unittest::TestRequired* release_proto2();
  inline void set_allocated_proto2(::protobuf_unittest::TestRequired* proto2);
