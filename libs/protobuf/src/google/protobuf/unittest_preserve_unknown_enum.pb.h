...
class MyMessage : public ::google::protobuf::Message {
 public:
  ...
  inline ::proto2_preserve_unknown_enum_unittest::MyEnum e() const;
  inline void set_e(::proto2_preserve_unknown_enum_unittest::MyEnum value);

  // repeated .proto2_preserve_unknown_enum_unittest.MyEnum repeated_e = 2;
  inline int repeated_e_size() const;
  inline void clear_repeated_e();
  static const int kRepeatedEFieldNumber = 2;
  inline ::proto2_preserve_unknown_enum_unittest::MyEnum repeated_e(int index) const;
  inline void set_repeated_e(int index, ::proto2_preserve_unknown_enum_unittest::MyEnum value);
  inline void add_repeated_e(::proto2_preserve_unknown_enum_unittest::MyEnum value);
  inline const ::google::protobuf::RepeatedField<int>& repeated_e() const;
  inline ::google::protobuf::RepeatedField<int>* mutable_repeated_e();

  // repeated .proto2_preserve_unknown_enum_unittest.MyEnum repeated_packed_e = 3 [packed = true];
  inline int repeated_packed_e_size() const;
  inline void clear_repeated_packed_e();
  static const int kRepeatedPackedEFieldNumber = 3;
  inline ::proto2_preserve_unknown_enum_unittest::MyEnum repeated_packed_e(int index) const;
  inline void set_repeated_packed_e(int index, ::proto2_preserve_unknown_enum_unittest::MyEnum value);
  inline void add_repeated_packed_e(::proto2_preserve_unknown_enum_unittest::MyEnum value);
  inline const ::google::protobuf::RepeatedField<int>& repeated_packed_e() const;
  inline ::google::protobuf::RepeatedField<int>* mutable_repeated_packed_e();

  // optional .proto2_preserve_unknown_enum_unittest.MyEnum oneof_e_1 = 4;
  private:
  inline bool has_oneof_e_1() const;
  public:
  inline void clear_oneof_e_1();
  static const int kOneofE1FieldNumber = 4;
  inline ::proto2_preserve_unknown_enum_unittest::MyEnum oneof_e_1() const;
  inline void set_oneof_e_1(::proto2_preserve_unknown_enum_unittest::MyEnum value);

  // optional .proto2_preserve_unknown_enum_unittest.MyEnum oneof_e_2 = 5;
  private:
  inline bool has_oneof_e_2() const;
  public:
  inline void clear_oneof_e_2();
  static const int kOneofE2FieldNumber = 5;
  inline ::proto2_preserve_unknown_enum_unittest::MyEnum oneof_e_2() const;
  inline void set_oneof_e_2(::proto2_preserve_unknown_enum_unittest::MyEnum value);
...
class MyMessagePlusExtra : public ::google::protobuf::Message {
 public:
  ...
  inline void clear_e();
  static const int kEFieldNumber = 1;
  inline ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra e() const;
  inline void set_e(::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra value);

  // repeated .proto2_preserve_unknown_enum_unittest.MyEnumPlusExtra repeated_e = 2;
  inline int repeated_e_size() const;
  inline void clear_repeated_e();
  static const int kRepeatedEFieldNumber = 2;
  inline ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra repeated_e(int index) const;
  inline void set_repeated_e(int index, ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra value);
  inline void add_repeated_e(::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra value);
  inline const ::google::protobuf::RepeatedField<int>& repeated_e() const;
  inline ::google::protobuf::RepeatedField<int>* mutable_repeated_e();
  ...
  inline void clear_repeated_packed_e();
  static const int kRepeatedPackedEFieldNumber = 3;
  inline ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra repeated_packed_e(int index) const;
  inline void set_repeated_packed_e(int index, ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra value);
  inline void add_repeated_packed_e(::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra value);
  inline const ::google::protobuf::RepeatedField<int>& repeated_packed_e() const;
  inline ::google::protobuf::RepeatedField<int>* mutable_repeated_packed_e();
  ...
  inline void clear_oneof_e_1();
  static const int kOneofE1FieldNumber = 4;
  inline ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra oneof_e_1() const;
  inline void set_oneof_e_1(::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra value);
  ...
  inline void clear_oneof_e_2();
  static const int kOneofE2FieldNumber = 5;
  inline ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra oneof_e_2() const;
  inline void set_oneof_e_2(::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra value);

  inline OCase o_case() const;
  // @@protoc_insertion_point(class_scope:proto2_preserve_unknown_enum_unittest.MyMessagePlusExtra)
 private:
  inline void set_has_oneof_e_1();
  inline void set_has_oneof_e_2();
...
inline ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra MyMessagePlusExtra::e() const {
  // @@protoc_insertion_point(field_get:proto2_preserve_unknown_enum_unittest.MyMessagePlusExtra.e)
  return static_cast< ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra >(e_);
}
inline void MyMessagePlusExtra::set_e(::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra value) {
  
  e_ = value;
  // @@protoc_insertion_point(field_set:proto2_preserve_unknown_enum_unittest.MyMessagePlusExtra.e)
}
...
inline ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra MyMessagePlusExtra::repeated_e(int index) const {
  // @@protoc_insertion_point(field_get:proto2_preserve_unknown_enum_unittest.MyMessagePlusExtra.repeated_e)
  return static_cast< ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra >(repeated_e_.Get(index));
}
inline void MyMessagePlusExtra::set_repeated_e(int index, ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra value) {
  repeated_e_.Set(index, value);
  // @@protoc_insertion_point(field_set:proto2_preserve_unknown_enum_unittest.MyMessagePlusExtra.repeated_e)
}
inline void MyMessagePlusExtra::add_repeated_e(::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra value) {
  repeated_e_.Add(value);
  // @@protoc_insertion_point(field_add:proto2_preserve_unknown_enum_unittest.MyMessagePlusExtra.repeated_e)
}
inline const ::google::protobuf::RepeatedField<int>&
MyMessagePlusExtra::repeated_e() const {
  // @@protoc_insertion_point(field_list:proto2_preserve_unknown_enum_unittest.MyMessagePlusExtra.repeated_e)
  return repeated_e_;
}
inline ::google::protobuf::RepeatedField<int>*
MyMessagePlusExtra::mutable_repeated_e() {
  // @@protoc_insertion_point(field_mutable_list:proto2_preserve_unknown_enum_unittest.MyMessagePlusExtra.repeated_e)
  return &repeated_e_;
}
...
inline ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra MyMessagePlusExtra::repeated_packed_e(int index) const {
  // @@protoc_insertion_point(field_get:proto2_preserve_unknown_enum_unittest.MyMessagePlusExtra.repeated_packed_e)
  return static_cast< ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra >(repeated_packed_e_.Get(index));
}
inline void MyMessagePlusExtra::set_repeated_packed_e(int index, ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra value) {
  repeated_packed_e_.Set(index, value);
  // @@protoc_insertion_point(field_set:proto2_preserve_unknown_enum_unittest.MyMessagePlusExtra.repeated_packed_e)
}
inline void MyMessagePlusExtra::add_repeated_packed_e(::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra value) {
  repeated_packed_e_.Add(value);
  // @@protoc_insertion_point(field_add:proto2_preserve_unknown_enum_unittest.MyMessagePlusExtra.repeated_packed_e)
}
inline const ::google::protobuf::RepeatedField<int>&
MyMessagePlusExtra::repeated_packed_e() const {
  // @@protoc_insertion_point(field_list:proto2_preserve_unknown_enum_unittest.MyMessagePlusExtra.repeated_packed_e)
  return repeated_packed_e_;
}
inline ::google::protobuf::RepeatedField<int>*
MyMessagePlusExtra::mutable_repeated_packed_e() {
  // @@protoc_insertion_point(field_mutable_list:proto2_preserve_unknown_enum_unittest.MyMessagePlusExtra.repeated_packed_e)
  return &repeated_packed_e_;
}
...
inline ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra MyMessagePlusExtra::oneof_e_1() const {
  // @@protoc_insertion_point(field_get:proto2_preserve_unknown_enum_unittest.MyMessagePlusExtra.oneof_e_1)
  if (has_oneof_e_1()) {
    return static_cast< ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra >(o_.oneof_e_1_);
  }
  return static_cast< ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra >(0);
}
inline void MyMessagePlusExtra::set_oneof_e_1(::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra value) {
  if (!has_oneof_e_1()) {
    clear_o();
    set_has_oneof_e_1();
  }
  o_.oneof_e_1_ = value;
  // @@protoc_insertion_point(field_set:proto2_preserve_unknown_enum_unittest.MyMessagePlusExtra.oneof_e_1)
}
...
inline ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra MyMessagePlusExtra::oneof_e_2() const {
  // @@protoc_insertion_point(field_get:proto2_preserve_unknown_enum_unittest.MyMessagePlusExtra.oneof_e_2)
  if (has_oneof_e_2()) {
    return static_cast< ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra >(o_.oneof_e_2_);
  }
  return static_cast< ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra >(0);
}
inline void MyMessagePlusExtra::set_oneof_e_2(::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra value) {
  if (!has_oneof_e_2()) {
    clear_o();
    set_has_oneof_e_2();
  }
  o_.oneof_e_2_ = value;
  // @@protoc_insertion_point(field_set:proto2_preserve_unknown_enum_unittest.MyMessagePlusExtra.oneof_e_2)
}
...
template <> struct is_proto_enum< ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra>() {
  return ::proto2_preserve_unknown_enum_unittest::MyEnumPlusExtra_descriptor();
}
