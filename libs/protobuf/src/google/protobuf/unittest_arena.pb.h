...
class ArenaMessage : public ::google::protobuf::Message {
 public:
  ...
  inline const ::proto2_arena_unittest::NestedMessage& repeated_nested_message(int index) const;
  inline ::proto2_arena_unittest::NestedMessage* mutable_repeated_nested_message(int index);
  inline ::proto2_arena_unittest::NestedMessage* add_repeated_nested_message();
  ...
  inline int repeated_import_no_arena_message_size() const;
  inline void clear_repeated_import_no_arena_message();
  static const int kRepeatedImportNoArenaMessageFieldNumber = 2;
  inline const ::proto2_arena_unittest::ImportNoArenaNestedMessage& repeated_import_no_arena_message(int index) const;
  inline ::proto2_arena_unittest::ImportNoArenaNestedMessage* mutable_repeated_import_no_arena_message(int index);
  inline ::proto2_arena_unittest::ImportNoArenaNestedMessage* add_repeated_import_no_arena_message();
