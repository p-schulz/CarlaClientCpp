...
class Foo : public ::google::protobuf::Message {
 public:
  ...
  inline void clear_enum_value();
  static const int kEnumValueFieldNumber = 2;
  inline ::unittest_drop_unknown_fields::Foo_NestedEnum enum_value() const;
  inline void set_enum_value(::unittest_drop_unknown_fields::Foo_NestedEnum value);
...
class FooWithExtraFields : public ::google::protobuf::Message {
 public:
  ...
  inline void clear_enum_value();
  static const int kEnumValueFieldNumber = 2;
  inline ::unittest_drop_unknown_fields::FooWithExtraFields_NestedEnum enum_value() const;
  inline void set_enum_value(::unittest_drop_unknown_fields::FooWithExtraFields_NestedEnum value);

  // optional int32 extra_int32_value = 3;
  inline void clear_extra_int32_value();
  static const int kExtraInt32ValueFieldNumber = 3;
  inline ::google::protobuf::int32 extra_int32_value() const;
  inline void set_extra_int32_value(::google::protobuf::int32 value);
